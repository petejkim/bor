...
func (h *handler) runEthPeer(peer *eth.Peer, handler eth.Handler) error {
	...
	if !peerInfo.Network.Trusted {
		...
		if strings.HasPrefix(peerFullName, "bor/v1.3.") || strings.HasPrefix(peerFullName, "bor/v1.2.") || strings.HasPrefix(peerFullName, "bor/v1.1.") || strings.HasPrefix(peerFullName, "bor/v1.0.") || strings.HasPrefix(peerFullName, "bor/v1.10") || strings.HasPrefix(peerFullName, "bor/v0.3.7-stable/linux/") {
