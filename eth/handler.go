...
func (h *handler) runEthPeer(peer *eth.Peer, handler eth.Handler) error {
	...
	if !peerInfo.Network.Trusted {
		...
		if (!strings.HasPrefix(peerFullName, "bor/v") && !strings.HasPrefix(peerFullName, "erigon/v")) ||
			...
			strings.HasPrefix(peerFullName, "bor/v2.2.10/") ||
			strings.HasPrefix(peerFullName, "erigon/v0.") ||
			strings.HasPrefix(peerFullName, "erigon/v1.") ||
			strings.HasPrefix(peerFullName, "erigon/v2.") {
